...
> You can simplify the version bump process by running `bun pm version patch`, `bun pm version minor` or `bun pm version major` after updating `minAppVersion` manually in `manifest.json`.
